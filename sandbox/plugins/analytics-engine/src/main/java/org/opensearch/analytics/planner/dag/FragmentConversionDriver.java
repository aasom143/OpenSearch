        ...
        Function<OperatorAnnotation, RexNode> resolverFor(OpenSearchRelNode operator, RexBuilder rexBuilder) {
            ...
            return new AnnotationResolver() {
                ...
                public RexNode apply(OperatorAnnotation annotation) {
                    ...
                    // Correctness-delegated single leaf that wasn't part of a subtree
                    // (e.g. inside a non-AND/OR/NOT call). Should not normally reach here
                    // since the classifier handles all AND/OR/NOT trees, but as a safety net:
